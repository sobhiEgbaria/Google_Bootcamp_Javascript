/*
  The `sumOfMultiples(curLimit)` function in JavaScript calculates the sum of all numbers up to a given limit 
  (`curLimit`) that are multiples of either 3 or 5.

  Here's a step-by-step breakdown of what the function does:

  1. It accepts one parameter, `curLimit`, which represents the upper limit of the range of numbers to check.
  2. It initializes a variable `sumOfMultipleValue` to 0.
  This variable will hold the sum of the multiples of 3 or 5.
